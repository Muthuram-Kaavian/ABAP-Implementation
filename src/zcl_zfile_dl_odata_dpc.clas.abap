class ZCL_ZFILE_DL_ODATA_DPC definition
  public
...
protected section.
  ...
  methods DOWNLOADFILESET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZFILE_DL_ODATA_MPC=>TS_FILEDOWNLOAD
    raising
  ...
  methods DOWNLOADFILESET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZFILE_DL_ODATA_MPC=>TT_FILEDOWNLOAD
...
CLASS ZCL_ZFILE_DL_ODATA_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 15.09.2025 06:09:46 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZFILE_DL_ODATA_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA downloadfileset_create_entity TYPE zcl_zfile_dl_odata_mpc=>ts_filedownload.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA downloadfileset_get_entity TYPE zcl_zfile_dl_odata_mpc=>ts_filedownload.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZFILE_DL_ODATA_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA downloadfileset_get_entityset TYPE zcl_zfile_dl_odata_mpc=>tt_filedownload.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA downloadfileset_update_entity TYPE zcl_zfile_dl_odata_mpc=>ts_filedownload.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
