class ZCL_Z_FILE_MPC definition
  public
...
CLASS ZCL_Z_FILE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_FILE_SRV' ).
...
lo_action = model->create_action( 'RunExport' ).  "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_Z_FILE_MPC=>TS_RUNEXPORT' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_FILE_MPC=>TS_RESULT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250918063354'.                  "#EC NOTEXT
