class ZCL_ZNOTE_STATUS_SRV_DPC definition
  public
...
protected section.
  ...
  methods NOTESET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZNOTE_STATUS_SRV_MPC=>TS_NOTE
    raising
  ...
  methods NOTESET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZNOTE_STATUS_SRV_MPC=>TT_NOTE
...
CLASS ZCL_ZNOTE_STATUS_SRV_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 06.11.2025 06:38:02 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZNOTE_STATUS_SRV_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA noteset_create_entity TYPE zcl_znote_status_srv_mpc=>ts_note.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA noteset_get_entity TYPE zcl_znote_status_srv_mpc=>ts_note.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZNOTE_STATUS_SRV_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA noteset_get_entityset TYPE zcl_znote_status_srv_mpc=>tt_note.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA noteset_update_entity TYPE zcl_znote_status_srv_mpc=>ts_note.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
